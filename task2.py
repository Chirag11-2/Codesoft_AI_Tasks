...
/*# sourceURL=ace/css/ace_scrollbar.css */</style>
  ...
  <link rel="stylesheet" href="./task2_files/fonts.css">
  ...
  <script async="" src="./task2_files/clarity.js.download"></script><script async="" src="./task2_files/kl8gh6lk26"></script><script type="text/javascript" async="" src="./task2_files/analytics.js.download"></script><script type="text/javascript" async="" src="./task2_files/js"></script><script async="" src="./task2_files/gtm.js.download"></script><script>
  ...
  <script src="./task2_files/stub.min.js.download"></script>
  <script async="" src="./task2_files/cmp.js.download"></script>
  ...
  <link rel="stylesheet" href="./task2_files/playground.css">
  <!-- Global site tag (gtag.js) - Google Analytics -->

<link rel="preconnect" href="https://cmp.uniconsent.com/"><script src="./task2_files/main-v5.min.js.download" async=""></script><script src="./task2_files/mode-python.js.download"></script><script src="./task2_files/theme-twilight.js.download"></script><script async="" src="./task2_files/Programizcomnew.min.js.download"></script><script async="" src="https://btloader.com/tag?o=5184339635601408&amp;upapi=true"></script></head>
        ...
        <div class="nav-header-wrapper">
          <div class="nav-logo-title-wrapper">
            <a href="https://www.programiz.com/" target="_blank" class="nav-logo-link">
              <img id="nav-logo" src="./task2_files/logo-inverted.svg">
            </a>
          </div>
...
<path d="M19.0562 11.0988C19.6709 11.2305 20.2295 11.5292 20.6606 11.9566C20.8976 12.1882 21.104 12.4451 21.2755 12.722C21.2834 12.7522 20.1683 13.4472 19.4921 13.835C19.4676 13.8504 19.3701 13.7519 19.2597 13.6006C19.1364 13.4034 18.9611 13.2385 18.7503 13.1214C18.5394 13.0042 18.3 12.9387 18.0544 12.9309C17.2771 12.8814 16.7762 13.2591 16.7799 13.8905C16.7731 14.0457 16.8113 14.1997 16.8903 14.3365C17.0613 14.6646 17.3789 14.8615 18.3763 15.2626C20.2124 15.9959 21.0005 16.4794 21.4869 17.1664C21.7618 17.6005 21.9311 18.0852 21.983 18.5864C22.0348 19.0876 21.968 19.5932 21.7872 20.0679C21.5388 20.5887 21.1445 21.0382 20.6455 21.3697C20.1464 21.7012 19.5607 21.9026 18.9494 21.953C18.2995 22.0214 17.6431 22.0151 16.9949 21.9342C16.0022 21.7829 15.0877 21.3408 14.3852 20.6726C14.1199 20.3952 13.8952 20.0865 13.7169 19.7545C13.7922 19.7034 13.871 19.6569 13.9529 19.6153C14.0669 19.555 14.4985 19.3246 14.9055 19.1057L15.6446 18.7039L15.799 18.9128C16.0596 19.2576 16.3906 19.5516 16.7734 19.778C17.1602 19.9749 17.5984 20.0682 18.0391 20.0475C18.4798 20.0268 18.9056 19.8929 19.2691 19.6608C19.4566 19.4912 19.5738 19.2659 19.6002 19.0242C19.6266 18.7825 19.5604 18.5399 19.4134 18.3389C19.2142 18.0744 18.8072 17.8521 17.6503 17.3867C16.7431 17.1029 15.9168 16.6325 15.2332 16.0106C14.9079 15.6662 14.6675 15.2601 14.5288 14.8207C14.4262 14.3199 14.4111 13.8071 14.4841 13.3019C14.6197 12.7205 14.9448 12.1918 15.4152 11.7877C15.8857 11.3835 16.4788 11.1234 17.114 11.0426C17.7608 10.9709 18.4155 10.9898 19.0562 11.0988ZM13.0348 12.0919L13.0428 13.0655H9.70119V21.8699H7.34477V13.0676H4.00319V12.1113C3.99432 11.7838 4.00396 11.4562 4.03206 11.1296C4.04433 11.1142 6.07598 11.1069 8.53922 11.1109L13.0218 11.1223L13.0348 12.0919Z" fill="black"></path>
          ...
          <a target="_blank" href="https://www.programiz.com/typescript/online-compiler/" class="change-lang-row typescript " title="Typescript Online Compiler (Editor)">
            <span class="change-lang-btn">
              <img class="change-lang-btn-icon svg" src="./task2_files/typescript.svg">
            </span>
            <span class="nav-menu-text">
    ...
    <path d="M16.5285 5.23613C16.4137 5.23203 16.2988 5.22793 16.1799 5.22793H5.34766L11.2211 2.2748C11.5246 2.09434 11.9922 2 12.468 2C13.0217 2 13.6738 2.37734 13.9855 2.68906L16.5285 5.23203V5.23613ZM5.40098 5.95801H16.1799C16.8361 5.95801 17.2217 6.01543 17.6318 6.33945L22 10.7035V19.2676L18.7475 19.2963L5.40098 5.95801ZM4.95801 17.2988V6.54453L18.2389 19.8254L18.2676 23H9.56406L5.54043 18.9723C5.07695 18.5088 4.95801 18.3447 4.95801 17.2988ZM4.22793 6.31895V17.2988C4.22793 17.4342 4.23203 17.5572 4.23613 17.6721L1.69316 15.1291C1.2666 14.6861 1 14.0709 1 13.468C1 13.1891 1.15996 12.7502 1.2748 12.5L4.22793 6.31895Z" fill="black"></path>
          ...
          <a target="_blank" href="https://www.programiz.com/ruby/online-compiler/" class="change-lang-row ruby " title="Ruby Online Compiler (Editor)">
            <span class="change-lang-btn">
              <img class="change-lang-btn-icon svg" src="./task2_files/ruby.svg">
            </span>
            <span class="nav-menu-text">
...
<rect width="40" height="40" fill="white"></rect>
    ...
    <div class="notification " id="notification" style="display:none;">
      <div class="check-icon-wrapper">
        <img src="./task2_files/check.svg" alt="check">
      </div>
          ...
          <div class="logo-wrapper">
            <h1 class="logo-title-wrapper">
              <a href="https://www.programiz.com/" target="_blank" class="logo-link">
                <img id="logo" src="./task2_files/logo-inverted.svg">
...
<path d="M11.5584 4.88281L6.44336 7.86781" stroke="white" stroke-width="1.77778" stroke-linecap="round" stroke-linejoin="round"></path>
        ...
        <div class="other-options-wrapper">
          ...
          <div class="mobile-top-bar-run-button run">
            ...
            <img src="./task2_files/play.svg" alt="run-icon">
          </div>
        </div>
      </div>
...
<path d="M11.5584 4.88281L6.44336 7.86781" stroke="white" stroke-width="1.77778" stroke-linecap="round" stroke-linejoin="round"></path>
        ...
        <div id="editor" class=" ace_editor ace-twilight ace_dark" style="font-family: &quot;Droid Sans Mono&quot;; font-size: 14px; line-height: 22px; height: 479px;"><textarea class="ace_text-input" wrap="off" autocorrect="off" autocapitalize="off" spellcheck="false" aria-haspopup="false" aria-autocomplete="both" role="textbox" aria-label="Cursor at row 92" style="opacity: 0; font-size: 1px; height: 1px; width: 1px; top: 478px; left: 213px;"></textarea><div class="ace_gutter" aria-hidden="true" style="left: 0px; width: 50px;"><div class="ace_layer ace_gutter-layer ace_folding-enabled" style="height: 1e+06px; top: -1721px; left: 0px; width: 50px;"><div class="ace_gutter-cell " aria-hidden="true" style="height: 44px; top: 1694px;">71<span tabindex="0" style="display: none;"></span><span tabindex="0" style="display: none;"><span></span></span></div><div class="ace_gutter-cell " aria-hidden="true" style="height: 22px; top: 1738px;">72<span tabindex="0" style="display: none;"></span><span tabindex="0" style="display: none;"><span></span></span></div><div class="ace_gutter-cell " aria-hidden="false" style="height: 22px; top: 1760px;">73<span tabindex="-1" style="display: inline-block; height: 22px;" class="ace_fold-widget ace_start ace_open" role="button" aria-label="Toggle code folding, rows 73 through 86" aria-expanded="true" title="Fold code"></span><span tabindex="0" style="display: none;"><span></span></span></div><div class="ace_gutter-cell " aria-hidden="true" style="height: 22px; top: 1782px;">74<span tabindex="0" style="display: none;"></span><span tabindex="0" style="display: none;"><span></span></span></div><div class="ace_gutter-cell " aria-hidden="false" style="height: 22px; top: 1804px;">75<span class="ace_fold-widget ace_start ace_open" role="button" tabindex="-1" aria-label="Toggle code folding, rows 75 through 76" aria-expanded="true" title="Fold code" style="height: 22px; display: inline-block;"></span><span tabindex="0" style="display: none;"><span></span></span></div><div class="ace_gutter-cell " aria-hidden="true" style="height: 22px; top: 1826px;">76<span tabindex="0" style="display: none;"></span><span tabindex="0" style="display: none;"><span></span></span></div><div class="ace_gutter-cell " aria-hidden="true" style="height: 22px; top: 1848px;">77<span tabindex="0" style="display: none;"></span><span tabindex="0" style="display: none;"><span></span></span></div><div class="ace_gutter-cell " aria-hidden="true" style="height: 22px; top: 1870px;">78<span tabindex="0" style="display: none;"></span><span tabindex="0" style="display: none;"><span></span></span></div><div class="ace_gutter-cell " aria-hidden="true" style="height: 22px; top: 1892px;">79<span tabindex="0" style="display: none;"></span><span tabindex="0" style="display: none;"><span></span></span></div><div class="ace_gutter-cell " aria-hidden="true" style="height: 22px; top: 1914px;">80<span tabindex="0" style="display: none;"></span><span tabindex="0" style="display: none;"><span></span></span></div><div class="ace_gutter-cell " aria-hidden="true" style="height: 22px; top: 1936px;">81<span tabindex="0" style="display: none;"></span><span tabindex="0" style="display: none;"><span></span></span></div><div class="ace_gutter-cell " aria-hidden="true" style="height: 22px; top: 1958px;">82<span tabindex="0" style="display: none;"></span><span tabindex="0" style="display: none;"><span></span></span></div><div class="ace_gutter-cell " aria-hidden="true" style="height: 22px; top: 1980px;">83<span tabindex="0" style="display: none;"></span><span tabindex="0" style="display: none;"><span></span></span></div><div class="ace_gutter-cell " aria-hidden="true" style="height: 22px; top: 2002px;">84<span tabindex="0" style="display: none;"></span><span tabindex="0" style="display: none;"><span></span></span></div><div class="ace_gutter-cell " aria-hidden="false" style="height: 22px; top: 2024px;">85<span class="ace_fold-widget ace_start ace_open" role="button" tabindex="-1" aria-label="Toggle code folding, rows 85 through 86" aria-expanded="true" title="Fold code" style="height: 22px; display: inline-block;"></span><span tabindex="0" style="display: none;"><span></span></span></div><div class="ace_gutter-cell " aria-hidden="true" style="height: 22px; top: 2046px;">86<span tabindex="0" style="display: none;"></span><span tabindex="0" style="display: none;"><span></span></span></div><div class="ace_gutter-cell " aria-hidden="true" style="height: 22px; top: 2068px;">87<span tabindex="0" style="display: none;"></span><span tabindex="0" style="display: none;"><span></span></span></div><div class="ace_gutter-cell " aria-hidden="true" style="height: 22px; top: 2090px;">88<span tabindex="0" style="display: none;"></span><span tabindex="0" style="display: none;"><span></span></span></div><div class="ace_gutter-cell " aria-hidden="false" style="height: 22px; top: 2112px;">89<span class="ace_fold-widget ace_start ace_open" role="button" tabindex="-1" aria-label="Toggle code folding, rows 89 through 92" aria-expanded="true" title="Fold code" style="height: 22px; display: inline-block;"></span><span tabindex="0" style="display: none;"><span></span></span></div><div class="ace_gutter-cell " aria-hidden="true" style="height: 22px; top: 2134px;">90<span tabindex="0" style="display: none;"></span><span tabindex="0" style="display: none;"><span></span></span></div><div class="ace_gutter-cell " aria-hidden="true" style="height: 22px; top: 2156px;">91<span tabindex="0" style="display: none;"></span><span tabindex="0" style="display: none;"><span></span></span></div><div class="ace_gutter-cell ace_gutter-active-line " aria-hidden="true" style="height: 22px; top: 2178px;">92<span tabindex="0" style="display: none;"></span><span tabindex="0" style="display: none;"><span></span></span></div></div></div><div class="ace_scroller " style="line-height: 22px; left: 49.8047px; right: 15px; bottom: 0px;"><div class="ace_content" style="top: -27px; left: 0px; width: 589.195px; height: 545px;"><div class="ace_layer ace_print-margin-layer"><div class="ace_print-margin" style="left: 676px; visibility: hidden;"></div></div><div class="ace_layer ace_marker-layer"><div class="ace_active-line" style="height: 22px; top: 484px; left: 0px; right: 0px;"></div><div class="ace_bracket ace_start ace_br15" style="height: 22px; width: 16.8047px; top: 484px; left: 146.84px;"></div></div><div class="ace_layer ace_text-layer" style="height: 1e+06px; margin: 0px 4px; top: -1694px; left: 0px;"><div class="ace_line_group" style="height: 44px; top: 1694px;"><div class="ace_line" style="height: 22px;"><span class="ace_indent-guide">    </span>    <span class="ace_keyword">return</span> <span class="ace_string">"Hmm... I didn't get that. Try typing 'help' to see </span></div><div class="ace_line" style="height: 22px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="ace_string">what I can do!"</span></div></div><div class="ace_line_group" style="height: 22px; top: 1738px;"><div class="ace_line" style="height: 22px;"></div></div><div class="ace_line_group" style="height: 22px; top: 1760px;"><div class="ace_line" style="height: 22px;">    <span class="ace_keyword">def</span> <span class="ace_entity ace_name ace_function">handle_input</span><span class="ace_paren ace_lparen">(</span><span class="ace_variable ace_language">self</span><span class="ace_punctuation">,</span> <span class="ace_identifier">event</span><span class="ace_keyword ace_operator">=</span><span class="ace_constant ace_language">None</span><span class="ace_paren ace_rparen">)</span><span class="ace_punctuation">:</span></div></div><div class="ace_line_group" style="height: 22px; top: 1782px;"><div class="ace_line" style="height: 22px;"><span class="ace_indent-guide">    </span>    <span class="ace_identifier">user_text</span> <span class="ace_keyword ace_operator">=</span> <span class="ace_variable ace_language">self</span><span class="ace_punctuation">.</span><span class="ace_function ace_support">user_input</span><span class="ace_punctuation">.</span><span class="ace_function ace_support">get</span><span class="ace_paren ace_lparen">(</span><span class="ace_paren ace_rparen">)</span></div></div><div class="ace_line_group" style="height: 22px; top: 1804px;"><div class="ace_line" style="height: 22px;"><span class="ace_indent-guide">    </span>    <span class="ace_keyword">if</span> <span class="ace_keyword">not</span> <span class="ace_identifier">user_text</span><span class="ace_punctuation">:</span></div></div><div class="ace_line_group" style="height: 22px; top: 1826px;"><div class="ace_line" style="height: 22px;"><span class="ace_indent-guide">    </span><span class="ace_indent-guide">    </span>    <span class="ace_keyword">return</span></div></div><div class="ace_line_group" style="height: 22px; top: 1848px;"><div class="ace_line" style="height: 22px;"></div></div><div class="ace_line_group" style="height: 22px; top: 1870px;"><div class="ace_line" style="height: 22px;"><span class="ace_indent-guide">    </span>    <span class="ace_variable ace_language">self</span><span class="ace_punctuation">.</span><span class="ace_function ace_support">display_message</span><span class="ace_paren ace_lparen">(</span><span class="ace_string">"You"</span><span class="ace_punctuation">,</span> <span class="ace_identifier">user_text</span><span class="ace_paren ace_rparen">)</span></div></div><div class="ace_line_group" style="height: 22px; top: 1892px;"><div class="ace_line" style="height: 22px;"><span class="ace_indent-guide">    </span>    <span class="ace_variable ace_language">self</span><span class="ace_punctuation">.</span><span class="ace_function ace_support">user_input</span><span class="ace_punctuation">.</span><span class="ace_function ace_support">delete</span><span class="ace_paren ace_lparen">(</span><span class="ace_constant ace_numeric">0</span><span class="ace_punctuation">,</span> <span class="ace_identifier">tk</span><span class="ace_punctuation">.</span><span class="ace_function ace_support">END</span><span class="ace_paren ace_rparen">)</span></div></div><div class="ace_line_group" style="height: 22px; top: 1914px;"><div class="ace_line" style="height: 22px;"></div></div><div class="ace_line_group" style="height: 22px; top: 1936px;"><div class="ace_line" style="height: 22px;"><span class="ace_indent-guide">    </span>    <span class="ace_identifier">bot_reply</span> <span class="ace_keyword ace_operator">=</span> <span class="ace_variable ace_language">self</span><span class="ace_punctuation">.</span><span class="ace_function ace_support">generate_reply</span><span class="ace_paren ace_lparen">(</span><span class="ace_identifier">user_text</span><span class="ace_paren ace_rparen">)</span></div></div><div class="ace_line_group" style="height: 22px; top: 1958px;"><div class="ace_line" style="height: 22px;"><span class="ace_indent-guide">    </span>    <span class="ace_variable ace_language">self</span><span class="ace_punctuation">.</span><span class="ace_function ace_support">display_message</span><span class="ace_paren ace_lparen">(</span><span class="ace_string">"Bot"</span><span class="ace_punctuation">,</span> <span class="ace_identifier">bot_reply</span><span class="ace_paren ace_rparen">)</span></div></div><div class="ace_line_group" style="height: 22px; top: 1980px;"><div class="ace_line" style="height: 22px;"></div></div><div class="ace_line_group" style="height: 22px; top: 2002px;"><div class="ace_line" style="height: 22px;"><span class="ace_indent-guide">    </span>    <span class="ace_comment"># Close the app after saying goodbye</span></div></div><div class="ace_line_group" style="height: 22px; top: 2024px;"><div class="ace_line" style="height: 22px;"><span class="ace_indent-guide">    </span>    <span class="ace_keyword">if</span> <span class="ace_string">"bye"</span> <span class="ace_keyword">in</span> <span class="ace_identifier">user_text</span><span class="ace_punctuation">.</span><span class="ace_function ace_support">lower</span><span class="ace_paren ace_lparen">(</span><span class="ace_paren ace_rparen">)</span> <span class="ace_keyword">or</span> <span class="ace_string">"exit"</span> <span class="ace_keyword">in</span> <span class="ace_identifier">user_text</span><span class="ace_punctuation">.</span><span class="ace_function ace_support">lower</span><span class="ace_paren ace_lparen">(</span><span class="ace_paren ace_rparen">)</span><span class="ace_punctuation">:</span></div></div><div class="ace_line_group" style="height: 22px; top: 2046px;"><div class="ace_line" style="height: 22px;"><span class="ace_indent-guide">    </span><span class="ace_indent-guide">    </span>    <span class="ace_variable ace_language">self</span><span class="ace_punctuation">.</span><span class="ace_function ace_support">window</span><span class="ace_punctuation">.</span><span class="ace_function ace_support">after</span><span class="ace_paren ace_lparen">(</span><span class="ace_constant ace_numeric">2000</span><span class="ace_punctuation">,</span> <span class="ace_variable ace_language">self</span><span class="ace_punctuation">.</span><span class="ace_function ace_support">window</span><span class="ace_punctuation">.</span><span class="ace_function ace_support">destroy</span><span class="ace_paren ace_rparen">)</span></div></div><div class="ace_line_group" style="height: 22px; top: 2068px;"><div class="ace_line" style="height: 22px;"></div></div><div class="ace_line_group" style="height: 22px; top: 2090px;"><div class="ace_line" style="height: 22px;"><span class="ace_comment"># Start the chatbot app</span></div></div><div class="ace_line_group" style="height: 22px; top: 2112px;"><div class="ace_line" style="height: 22px;"><span class="ace_keyword">if</span> <span class="ace_identifier">__name__</span> <span class="ace_keyword ace_operator">==</span> <span class="ace_string">"__main__"</span><span class="ace_punctuation">:</span></div></div><div class="ace_line_group" style="height: 22px; top: 2134px;"><div class="ace_line" style="height: 22px;">    <span class="ace_identifier">root</span> <span class="ace_keyword ace_operator">=</span> <span class="ace_identifier">tk</span><span class="ace_punctuation">.</span><span class="ace_function ace_support">Tk</span><span class="ace_paren ace_lparen">(</span><span class="ace_paren ace_rparen">)</span></div></div><div class="ace_line_group" style="height: 22px; top: 2156px;"><div class="ace_line" style="height: 22px;">    <span class="ace_identifier">chatbot</span> <span class="ace_keyword ace_operator">=</span> <span class="ace_identifier">SimpleChatbot</span><span class="ace_paren ace_lparen">(</span><span class="ace_identifier">root</span><span class="ace_paren ace_rparen">)</span></div></div><div class="ace_line_group" style="height: 22px; top: 2178px;"><div class="ace_line" style="height: 22px;">    <span class="ace_identifier">root</span><span class="ace_punctuation">.</span><span class="ace_function ace_support">mainloop</span><span class="ace_paren ace_lparen">(</span><span class="ace_paren ace_rparen">)</span></div></div></div><div class="ace_layer ace_marker-layer"></div><div class="ace_layer ace_cursor-layer ace_hidden-cursors"><div class="ace_cursor" style="display: block; top: 484px; left: 164px; width: 8px; height: 22px; animation-duration: 1000ms;"></div></div></div></div><div class="ace_scrollbar ace_scrollbar-v" style="width: 20px; height: 479px; bottom: 0px;"><div class="ace_scrollbar-inner" style="width: 20px; height: 2200px;">&nbsp;</div></div><div class="ace_scrollbar ace_scrollbar-h" style="display: none; height: 20px; left: 49.8047px; right: 15px; width: 589.195px;"><div class="ace_scrollbar-inner" style="height: 20px; width: 612px;">&nbsp;</div></div><div style="height: auto; width: auto; top: 0px; left: 0px; visibility: hidden; position: absolute; white-space: pre; font: inherit; overflow: hidden;"><div style="height: auto; width: auto; top: 0px; left: 0px; visibility: hidden; position: absolute; white-space: pre; font: inherit; overflow: visible;">הההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההה</div><div style="height: auto; width: auto; top: 0px; left: 0px; visibility: hidden; position: absolute; white-space: pre; font-style: inherit; font-variant: inherit; font-stretch: inherit; font-size: inherit; line-height: inherit; font-family: inherit; font-optical-sizing: inherit; font-size-adjust: inherit; font-kerning: inherit; font-feature-settings: inherit; font-variation-settings: inherit; overflow: visible;"></div></div><div class="ace_tooltip" role="tooltip" style="display: none; pointer-events: auto;"></div></div>
      </div>
